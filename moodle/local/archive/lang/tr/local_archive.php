...
$string['course_short_name'] = 'Dersin Kısa Adi';
$string['course_full_name'] = 'Dersin Tam Adi';
$string['record_type'] = 'Kaydın Tipi';
$string['date_of_the_record'] = 'Kaydın Tarihi';
$string['time_created'] = 'Olusturulma Tarihi';
$string['time_modified'] = 'Degistirme Tarihi';
